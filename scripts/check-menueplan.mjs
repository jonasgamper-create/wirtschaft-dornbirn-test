...
check('Gericht ohne eigenen Preis bekommt die Vorgabe', plan.tage[1].gerichte[0].preis === 15.9);
check('Vital ohne eigenen Preis bekommt die Vital-Vorgabe', plan.vital[0].preis === 15.9);
