...
export function pruefeAnfrage(roh, { heute, tageImVoraus = 90 } = {}) {
  ...
  // Online bis 10 Personen (Kundenwunsch vom 16.09., vorher 20). Groessere
  // Gesellschaften gehoeren ans Telefon: da haengen Menue, Anzahlung und
  // Raumaufteilung dran, die kein Formular abfragen soll.
  if (!Number.isFinite(guests) || guests < 1 || guests > 10) return { ok: false, grund: 'personen' };
