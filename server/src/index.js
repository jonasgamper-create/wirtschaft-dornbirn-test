...
export class Haus extends DurableObject {
   ...
   * Die Abende beider Haeuser, gelesen beim Ticketdienst.
   *
   * Eine Quelle, und zwar die, bei der verkauft wird. Die Kennungen stehen
   * in ticketist.mjs; sie kommen aus dem Verwaltungsbereich des Dienstes
   * und sind damit dieselben, unter denen dort verkauft wird - geraten
   * wird nichts (Jonas, 14.09.).
   *
   * Jeder Abend liegt einzeln im Speicher und haelt zwoelf Stunden. Je
   * Aufruf werden hoechstens sechs veraltete nachgeholt, die aeltesten
   * zuerst, und zwar NACH der Antwort (waitUntil): der Gast wartet nie auf
   * einen fremden Dienst. Beim ersten Mal holen wir acht sofort, damit die
   * Seite nicht leer bleibt.
   *
   * Zum Schluss werden die zwei Wege zu einem Abend zusammengelegt -
