(() => {
  ...
  const fallbackEventData = {
    ...
    events: [
      ...
      { id: "event-2026-09-22", date: "2026-09-22", title: "helden reisen, gäste speisen!", type: "4 comedians in verschiedenen haltestellen", status: "sold_out", officialUrl: undefined, tickets: [{ name: "dinner & comedy (sitzplatz)", preis: 88, beginn: "18:45", status: "ausverkauft" }], ticketUrl: "https://www.ticketist.io/events/comedynacht-05-2026-1" },
      ...
      { id: "event-2026-10-14", date: "2026-10-14", title: "dinner & comedy", type: "3 comedians | an einem abend | auf einer bühne", status: "teilweise", officialUrl: undefined, tickets: [{ name: "dinner & comedy (sitzplatz)", preis: 68, beginn: "19:00", status: "ausverkauft" }, { name: "comedy only: comedy only (stehplatz)", preis: 28, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/dinner-comedy-04-2026" },
      ...
      { id: "event-2026-10-15", date: "2026-10-15", title: "christof spörk", type: "programm: maximo lieder", status: "scheduled", officialUrl: undefined, tickets: [{ name: "dinner & comedy (sitzplatz)", preis: 68, beginn: "19:00", status: "buchbar" }, { name: "comedy only: comedy only (stehplatz)", preis: 28, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/spoerk-2026" },
      ...
      { id: "event-2026-10-22", date: "2026-10-22", title: "rock4 - a cappella", type: "the music of queen: a night at the opera, 50th anniversary", status: "sold_out", officialUrl: undefined, tickets: [{ name: "dinner & konzert (sitzplatz)", preis: 68, beginn: "19:00", status: "ausverkauft" }, { name: "konzert only: konzert only (stehplatz)", preis: 28, beginn: "19:00", status: "ausverkauft" }], ticketUrl: "https://www.ticketist.io/events/rock4-2026" },
      ...
      { id: "event-2026-10-27", date: "2026-10-27", title: "mathias kellner", type: "programm: schnappschuss!", status: "scheduled", officialUrl: undefined, tickets: [{ name: "dinner & konzert (sitzplatz)", preis: 68, beginn: "19:00", status: "buchbar" }, { name: "konzert only: konzert only (stehplatz)", preis: 28, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/kellner-2026" },
      ...
      { id: "event-2026-11-11", date: "2026-11-11", title: "dinner & comedy", type: "3 comedians | an einem abend | auf einer bühne", status: "teilweise", officialUrl: undefined, tickets: [{ name: "dinner & comedy (sitzplatz)", preis: 68, beginn: "19:00", status: "ausverkauft" }, { name: "comedy only: comedy only (stehplatz)", preis: 28, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/dinner-comedy-05-2026" },
      ...
      { id: "event-2026-11-18", date: "2026-11-18", title: "philipp lingg's musikzimmer", type: "das musikalische blind date", status: "scheduled", officialUrl: undefined, tickets: [{ name: "dinner & konzert (sitzplatz)", preis: 68, beginn: "19:00", status: "buchbar" }, { name: "konzert only: konzert only (stehplatz)", preis: 28, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/philippsmusikzimmer-02-2026" },
      { id: "event-2026-11-19", date: "2026-11-19", title: "hanskaspas enkel & george nussbaumer", type: "programm: „eine reise ins glück“ … und andere wa(h)rheiten", status: "scheduled", officialUrl: undefined, tickets: [{ name: "dinner & konzert (sitzplatz)", preis: 68, beginn: "19:00", status: "buchbar" }, { name: "konzert only: konzert only (stehplatz)", preis: 28, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/hanskaspasenkel-2026" },
      { id: "event-2026-11-24", date: "2026-11-24", title: "notenlos", type: "das wunschkonzert der extraklasse", status: "scheduled", officialUrl: undefined, tickets: [{ name: "dinner & konzert (sitzplatz)", preis: 68, beginn: "19:00", status: "buchbar" }, { name: "konzert only: konzert only (stehplatz)", preis: 28, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/notenlos-2026" },
      ...
      { id: "event-2026-11-26", date: "2026-11-26", title: "krauthobel anplakt", type: "In der „wirtschaft“", status: "scheduled", officialUrl: undefined, tickets: [{ name: "dinner & konzert (sitzplatz)", preis: 78, beginn: "19:00", status: "buchbar" }, { name: "konzert only: konzert only (stehplatz)", preis: 38, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/krauthobel-2026" },
      { id: "event-2026-12-03", date: "2026-12-03", title: "rebel tell", type: "schlagerbilly - chaos, herzblut & eskalation", status: "scheduled", officialUrl: undefined, tickets: [{ name: "dinner & konzert (sitzplatz)", preis: 68, beginn: "19:00", status: "buchbar" }, { name: "konzert only: konzert only (stehplatz)", preis: 28, beginn: "19:00", status: "buchbar" }], ticketUrl: "https://www.ticketist.io/events/rebeltell-2026" },
  ...
  function renderEventLists() {
    ...
    const renderTicketLink = item => {
      ...
      // Ausverkauft: auf die eigene Warteliste statt zum Ticketdienst, wo
      // nichts mehr zu holen ist. Die Eventseite oeffnet sie fuer diesen Weg.
      const kennung = (String(item.ticketUrl || '').match(/\/events\/([a-z0-9-]+)/) || [])[1] || '';
      if (item.status === 'sold_out' && kennung) {
        return `<a class="event-ticket-link event-status-sold_out" href="events.html?warteliste=${escapeHtml(kennung)}">Ausverkauft · Warteliste</a>`;
      }
  ...
  function renderTicketDetail() {
    ...
    // Der Weg auf die Warteliste: die Eventseite oeffnet sie fuer genau
    // diesen Abend. Kennung aus dem Ticketlink, wie ueberall.
    const kennung = (String(event.ticketUrl || '').match(/\/events\/([a-z0-9-]+)/) || [])[1] || '';
    const wartelisteLink = kennung && (event.status === 'sold_out' || event.status === 'teilweise' || event.status === 'waitlist')
      ? `<p class="ticket-detail-warteliste"><a class="event-ticket-link event-status-sold_out" href="events.html?warteliste=${escapeHtml(kennung)}">Auf die Warteliste</a></p>`
      : '';
