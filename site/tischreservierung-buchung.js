...
import { apiAdresse, buche, holeAmpel, holeFrei, holeGeschlossen, holeKarteInfo, holeTakeawayKarte, karteAdresse, meldeMittagskarte, trageWartelisteEin } from './haus-api.js?v=fd2a5ef6';
import { ladePlan, legende, wochenText, zeichneAlacarte, zeichneWoche } from './menuekarte.mjs?v=96ca3f6a';
